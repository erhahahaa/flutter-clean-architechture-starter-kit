...
UserEntity _userEntityDeserialize(
  ...
  final object = UserEntity(
    ...
    role: _UserEntityroleValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        UserRole.user,
  );
  return object;
}
...
extension UserEntityQueryWhereSort
  ...
  QueryBuilder<UserEntity, UserEntity, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension UserEntityQueryWhere
  ...
  QueryBuilder<UserEntity, UserEntity, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<UserEntity, UserEntity, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<UserEntity, UserEntity, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension GetTokenEntityCollection on Isar {
  IsarCollection<TokenEntity> get tokenEntitys => this.collection();
}

const TokenEntitySchema = CollectionSchema(
  name: r'TokenEntity',
  ...
  links: {},
  embeddedSchemas: {},
  getId: _tokenEntityGetId,
  getLinks: _tokenEntityGetLinks,
  attach: _tokenEntityAttach,
  version: '3.1.0+1',
);
...
Id _tokenEntityGetId(TokenEntity object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _tokenEntityGetLinks(TokenEntity object) {
  return [];
}

void _tokenEntityAttach(
    IsarCollection<dynamic> col, Id id, TokenEntity object) {
  object.id = id;
}

extension TokenEntityQueryWhereSort
    on QueryBuilder<TokenEntity, TokenEntity, QWhere> {
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension TokenEntityQueryWhere
    on QueryBuilder<TokenEntity, TokenEntity, QWhereClause> {
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
        upper: id,
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: id, includeLower: include),
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: id, includeUpper: include),
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TokenEntityQueryFilter
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterFilterCondition> idEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterFilterCondition> idGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TokenEntity, TokenEntity, QAfterFilterCondition> tokenIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'token',
      ));
...
extension TokenEntityQueryLinks
    on QueryBuilder<TokenEntity, TokenEntity, QFilterCondition> {}

extension TokenEntityQuerySortBy
    on QueryBuilder<TokenEntity, TokenEntity, QSortBy> {
  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> sortByToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.asc);
    });
  }

  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> sortByTokenDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TokenEntityQuerySortThenBy
    on QueryBuilder<TokenEntity, TokenEntity, QSortThenBy> {
  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> thenByToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.asc);
    });
  }

  QueryBuilder<TokenEntity, TokenEntity, QAfterSortBy> thenByTokenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.desc);
    });
  }
...
extension TokenEntityQueryWhereDistinct
    on QueryBuilder<TokenEntity, TokenEntity, QDistinct> {
  QueryBuilder<TokenEntity, TokenEntity, QDistinct> distinctByToken(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TokenEntityQueryProperty
    on QueryBuilder<TokenEntity, TokenEntity, QQueryProperty> {
  QueryBuilder<TokenEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<TokenEntity, String?, QQueryOperations> tokenProperty() {
    return QueryBuilder.apply(this, (query) {
